...
<head>
    <meta charset="utf-8">
    <title>Intranet CENEX :: Aluno</title>
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top ntw-bg">
        <a class="logo-cenex" href="/interno/cenex/sistema/usuario/aluno/"><img src="/interno/cenex/sistema/public/img/logo-cenex.svg" width="150px" height="auto" alt="Logo CENEX FAO"></a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExampleDefault" aria-controls="navbarsExampleDefault" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a class="nav-link" href="/interno/cenex/sistema/usuario/aluno/">Início</a></li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="/interno/cenex/sistema/usuario/aluno/acoes/listar/projeto">Listar projeto</a>
                        <a class="dropdown-item" href="/interno/cenex/sistema/usuario/aluno/acoes/listar/evento">Listar evento</a>
                        <a class="dropdown-item" href="https://sistemas.odonto.ufmg.br/interno/cenex/sistema/usuario/aluno/acoes/editar/">Editar inscrição</a>
                        <a class="dropdown-item" href="https://sistemas.odonto.ufmg.br/interno/cenex/sistema/usuario/aluno/acoes/gerenciar/">Gerenciar certificados</a>
                    </div>
                </li>
    ...
    <div class="navbar fixed-top sombra container-fluid">
        <ul class="nav">
            ...
            <li><i class="fas fa-home"></i> Painel do Aluno</li>
        </ul>
