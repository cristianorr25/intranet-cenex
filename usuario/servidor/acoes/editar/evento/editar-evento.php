...
<form action="/interno/cenex/assets/action/editar-evento.php" method="post">
<input type="hidden" value="<?php echo $row['id'];?>" name="id">     
<section class="conteudo">
    <h3 class="text-center">Servidor :: Editar ação de extensão</h3>
    <div class="row">
        <div class="col">
            <form class="container-fluid list-box text-left p-4">    
                ...
                <div class="form-row">     
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" name="valorEvento"  value="<?php echo$row['valorEvento'];?>" />
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="col text-center mt-5 mb-4">
                     ...
                     <a class="btn btn-secondary" href="/interno/cenex/sistema/usuario/servidor/acoes/listar/evento/">Voltar</a>  
                </div>              
