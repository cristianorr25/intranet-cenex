...
<section class="conteudo">
    <h3 class="text-center">Servidor :: Gerenciar Certificados</h3>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col text-left">
                                    ...
                                    if($row['tipoInscricao'] == "1") echo "  <strong><font color='#00000'>  Bolsista </font></strong>  "; 
                                    if($row['tipoInscricao'] == "2") echo "  <strong><font color='#00000'>  Voluntário </font></strong> "; 
                                  ...
                                  <input type="hidden" value="<?php echo $row['cpf_professor'];?>" name="cpf_aluno">
                                    <div class="align-middle">
                                        <ul class="nav nav-pills">
                                                <li class="nav-item">
                                                <button type="submit" formaction="/interno/cenex/sistema/usuario/servidor/acoes/gerenciar/certificado/" class=" nav-link mt-1 btn btn-success">Liberar Certificado</button>
                                                </li>                                                                        
                                        </ul>
                                   </div>             
                                </div>                 
        ...
        <?php }  ?>
            ...
            <div class="col text-center mt-3 mb-4">
                ...
                <form action="" method="POST" name="projetos" id="projetos">
                    <input type="hidden" value="<?php echo $row['id_projeto'];?>" name="id">
                    <button type ="submit" formaction="/interno/cenex/sistema/usuario/servidor/" class=" btn btn-secondary ">Voltar</button>
                </form>  
            </div>
    </div>
</section>
