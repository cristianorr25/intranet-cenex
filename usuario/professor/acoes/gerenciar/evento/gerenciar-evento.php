...
<section class="conteudo">
    <h3 class="text-center"><?php if($row['tipoProjeto'] == "Projeto") echo "Projeto" ; if($row['tipoProjeto'] == "Evento") echo "Evento" ?> :: <?php echo $row['nomeEvento']?></h3>
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <a href="/interno/cenex/sistema/usuario/professor/acoes/gerenciar/evento/administrar/?id=<?php echo $row['id'];?>">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a href="/interno/cenex/sistema/usuario/professor/acoes/gerenciar/evento/listar/?id=<?php echo $row['id'];?>">
                            <div class="box">
